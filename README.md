...
## Master stack launcher

Use the top-level interactive console:

```bash
./pendulum_stack.sh
```

The launcher auto-discovers the repository root, data/model/config artifacts, and provides menu-driven access to:
- IMU viewer overlays,
- Chrono runtime checks,
- ROS/data collection actions,
- nominal/actuator/sparse identification pipelines,
- RL calibration training,
- environment checks and quick project help.
