...
def main():
    ...
    if calib is not None:
        model_init_mode = "loaded_calibration_json"
    if args.parameter_json:
        ...
        cfg.K_u_init = float(init_params["K_u"])
        cfg.l_com_init = float(init_params["l_com"])
        cfg.b_eq_init = float(init_params["b_eq"])
        cfg.tau_eq_init = float(init_params["tau_eq"])
